...
mv ./WebTop/Desktop/record.sh ./WebTop/Desktop/1_record.sh & echo "Moving recorder"
mv ./WebTop/Desktop/replay.sh ./WebTop/Desktop/2_replay.sh & echo "Moving replay"
mv ./WebTop/Desktop/validate.sh ./WebTop/Desktop/3_validate.sh & echo "Moving validate"
